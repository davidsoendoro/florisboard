...
class TransactionKeyboardRecyclerAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return (ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_transactionkeyboard, parent, false)))
    }

    override fun onBindViewHolder(holder: TransactionKeyboardRecyclerAdapter.ViewHolder, position: Int) {
