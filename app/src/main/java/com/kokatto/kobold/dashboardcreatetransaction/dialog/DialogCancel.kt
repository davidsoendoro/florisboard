...
class DialogCancel : BottomSheetDialogFragment() {

    val TAG = "DialogCancel"
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.dialog_confirm_cancel, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        progressBarLoading = view.findViewById<ProgressBar>(R.id.confirm_button_loading)
        confirmBtn = view.findViewById<TextView>(R.id.confirm_button)
        cancelBtn = view.findViewById<TextView>(R.id.cancel_button)
