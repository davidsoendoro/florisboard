...
class DialogPaid : BottomSheetDialogFragment() {

    val TAG = "DialogPaid"

    fun newInstance(): DialogPaid? {
        return DialogPaid()
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.dialog_confirm_paid, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val progressBarLoading = view.findViewById<ProgressBar>(R.id.confirm_button_loading)
