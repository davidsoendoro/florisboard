...
class DialogBankDelete : RoundedBottomSheet() {

    val TAG = "DialogBankDelete"
    ...
    override fun onCreateView(
        ...
        uiBinding?.confirmTitle?.text = resources.getString(R.string.kobold_bank_dialog_delete_title)
        uiBinding?.confirmDesc?.text = resources.getString(R.string.kobold_bank_dialog_delete_desc)
        uiBinding?.confirmButton?.text = resources.getString(R.string.kobold_bank_dialog_delete_action_confirm)
        uiBinding?.confirmCancelButton?.text = resources.getString(R.string.kobold_bank_dialog_delete_action_cancel)
