...
class DialogClearConfirm : BottomSheetDialogFragment() {

    val TAG = "DialogClearConfirm"

    fun newInstance(): DialogClearConfirm? {
        return DialogClearConfirm()
    }
    ...
    override fun onCreateView(
        ...
        uiBinding?.confirmTitle?.text = resources.getString(R.string.kobold_template_dialog_clear_title)
        uiBinding?.confirmDesc?.text = resources.getString(R.string.kobold_template_dialog_clear_desc)
        uiBinding?.confirmButton?.text = resources.getString(R.string.kobold_template_dialog_clear_action_confirm)
        uiBinding?.confirmCancelButton?.text = resources.getString(R.string.kobold_template_dialog_clear_action_cancel)
