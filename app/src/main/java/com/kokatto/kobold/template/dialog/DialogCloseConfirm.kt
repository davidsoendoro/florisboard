...
class DialogCloseConfirm : BottomSheetDialogFragment() {

    val TAG = "DialogCloseConfirm"

    fun newInstance(): DialogCloseConfirm {
        return DialogCloseConfirm()
    }
    ...
    override fun onCreateView(
        ...
        uiBinding?.confirmTitle?.text = resources.getString(R.string.kobold_template_dialog_exit_title)
        uiBinding?.confirmDesc?.text = resources.getString(R.string.kobold_template_dialog_exit_desc)
        uiBinding?.confirmButton?.text = resources.getString(R.string.kobold_template_dialog_exit_action_confirm)
        uiBinding?.confirmCancelButton?.text = resources.getString(R.string.kobold_template_dialog_exit_action_cancel)
